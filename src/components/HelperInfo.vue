<template>
  <section class="container">
    ...
    <br>
    Wenn DU also daran interessiert bist, dich unverbindlich ehrenamtlich zu betätigen und dabei viele neue Gesichter kennen zu lernen, dann bist du bei uns genau richtig. Komm doch einfach mal vorbei oder melde dich bei uns via FB-Nachricht oder Email!
    <br>
    </p>
    <p>
